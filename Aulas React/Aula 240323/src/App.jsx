        ...
        <Routes>
          ...
          */}
          <Route path="/" element={<Root />}>
            ...
            <Route path="/cadastro/pokemon" element={<Pokemon />} />
            <Route path="/cadastro/herois" element={<Herois />} />
            <Route path="/cadastro/equipamento" element={<Equipamento />} />
            <Route path="/cadastro/programador" element={<Programadores />} />
